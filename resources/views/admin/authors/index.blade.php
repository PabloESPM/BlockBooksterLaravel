...
@section('content')
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-4xl font-black uppercase font-display">Authors</h1>
            ...
            <x-card class="group">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-16 h-16 bg-gray-200 rounded-full border-2 border-black flex-shrink-0 overflow-hidden">
                        <img src="https://ui-avatars.com/api/?name=Author+{{$i}}&background=random"
                            class="w-full h-full object-cover">
                    </div>
                    <div>
                        <h3 class="font-bold uppercase leading-tight group-hover:text-brand-blue">Stephen King</h3>
                        <p class="text-xs text-gray-500 font-bold uppercase">65 Books</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <button class="flex-1 neo-btn-secondary py-1 text-xs">Edit</button>
                    <button
                        class="bg-red-50 border-2 border-black px-3 py-1 text-xs font-bold uppercase hover:bg-red-500 hover:text-white transition-colors">Delete</button>
                </div>
            </x-card>
        @endfor
    </div>
