        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
                ...
                <div>
                    ...
                    <button
                        class="bg-white text-black border-2 border-black font-bold uppercase px-6 py-2 shadow-[4px_4px_0px_#000] hover:translate-y-[-2px] hover:shadow-[6px_6_0px_#000] transition-all">Ver
                        Lista</button>
                </div>
