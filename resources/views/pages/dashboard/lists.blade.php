...
@section('content')
    <div class="flex flex-col lg:flex-row gap-8" x-data="{ showModal: false }">
        <!-- Sidebar -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @empty
                    <div class="col-span-full text-center py-12 border-2 border-dashed border-black bg-gray-50">
                        ...
                        <button @click="showModal = true" class="mt-4 text-brand-blue underline font-bold">Create your first
                            list</button>
                    </div>
                @endforelse
            </div>
                ...
                <form action="{{ route('dashboard.lists.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-black border-l-2 border-black bg-gray-100">
