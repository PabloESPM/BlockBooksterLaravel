                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <a href="#"
                       class="w-10 h-10 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M7 2C4.239 2 2 4.239 2 7v10c0 2.761 2.239 5 5 5h10c2.761 0 5-2.239 5-5V7c0-2.761-2.239-5-5-5H7zm10 2c1.654 0 3 1.346 3 3v10c0 1.654-1.346 3-3 3H7c-1.654 0-3-1.346-3-3V7c0-1.654 1.346-3 3-3h10zm-5 3a5 5 0 100 10 5 5 0 000-10zm0 2a3 3 0 110 6 3 3 0 010-6zm4.5-.9a1.1 1.1 0 100 2.2 1.1 1.1 0 000-2.2z" />
                        </svg>
                    </a>
                    ...
                    <a href="#"
                       class="w-10 h-10 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12.75 2h2.1c.3 2.1 1.8 3.9 3.9 4.2v2.1c-1.5 0-3-.6-4.2-1.5v7.5a5.25 5.25 0 11-5.25-5.25c.3 0 .6 0 .9.1v2.3a2.85 2.85 0 10 2.55 2.85V2z" />
                        </svg>
                    </a>
                    ...
                    <a href="#"
                       class="w-10 h-10 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M22 12a10 10 0 10-11.5 9.9v-7H8v-3h2.5V9.5c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.4h-1.2c-1.2 0-1.6.7-1.6 1.5V12H16l-.5 3h-2.6v7A10 10 0 0022 12z" />
                        </svg>
                    </a>
                    ...
                    <a href="#"
                       class="w-10 h-10 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 2c2.5 2.6 4.6 4.1 7.5 5.2-.4 3.5-1.6 6.5-4.3 8.9L12 22l-3.2-5.9C6.1 13.7 4.9 10.7 4.5 7.2 7.4 6.1 9.5 4.6 12 2z" />
                        </svg>
                    </a>
                </div>
            </div>
