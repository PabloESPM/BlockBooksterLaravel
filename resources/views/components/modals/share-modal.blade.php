<div x-data="{ 
        ...
        show = true; 
        title = $event.detail.title || 'Share';
    ...
    <div @click.away="show = false"
        ...
        <p class="font-bold text-sm text-gray-600 mb-4">Copy the link below to share with your friends:</p>
        ...
        <div class="flex flex-col gap-3">
            ...
            <button
                @click="navigator.clipboard.writeText(url); $el.innerText = 'Copied!'; setTimeout(() => $el.innerText = 'Copy Link', 2000)"
