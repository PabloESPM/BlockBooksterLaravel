    ...
    <div @click.away="show = false"
        ...
        <div class="overflow-y-auto pr-2 custom-scrollbar flex-grow" id="user-list-container">
            ...
            <div x-show="loading" class="py-4 text-center">
                <span class="font-bold uppercase animate-pulse">Cargando...</span>
            </div>
    ...
    <script>
        function loadUsers() {
            ...
            const url = type === 'followers'
                ? `/users/${userId}/load-followers?page=${nextPage}`  // cargar seguidores
                : `/users/${userId}/load-following?page=${nextPage}`; // cargar seguidos
