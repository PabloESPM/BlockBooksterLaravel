...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        return [
            'books' => $this->author->books()->with('reviews')->paginate($this->perPage),
        ];
    }

    public function rendering($view)
    {
        $view->title($this->author->name . ' ' . $this->author->surname . ' - Perfil del Autor');
    }
}; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="neo-card p-6 text-sm leading-relaxed font-medium">
                ...
                <a href="#" class="block mt-4 font-bold uppercase underline hover:text-brand-blue">Leer biografía
                    completa en Wikipedia -></a>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            ...
            <div class="mt-8">
                <button wire:click="loadMore" wire:loading.attr="disabled"
                    class="w-full neo-btn-secondary flex items-center justify-center gap-2">
                    <span wire:loading
