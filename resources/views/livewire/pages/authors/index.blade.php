...
new #[Layout('layouts.app')] #[Title('Autores')] class extends Component {
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach ($classicAuthors as $author)
                <div class="neo-card p-6 flex items-center gap-6">
                    ...
                    <div>
                        <a href="{{ route('authors.show', $author->id) }}" wire:navigate>
            ...
            @foreach ($newAuthors as $author)
                <div class="neo-card p-4 hover:-translate-y-1 transition-transform">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-10 h-10 bg-black rounded-full text-white flex items-center justify-center font-bold text-[10px] uppercase">Nuevo
                        </div>
                        <div>
                            <a href="{{ route('authors.show', $author->id) }}" wire:navigate>
